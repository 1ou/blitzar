...
set CLASSPATH=%APP_HOME%\lib\gateway.jar

@rem Execute gateway
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GATEWAY_OPTS%  -classpath "%CLASSPATH%" io.toxa108.blitzar.gatewayGatewayApplication %CMD_LINE_ARGS%
